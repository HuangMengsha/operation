...
//        a.add(a1.peek().result);
    ...
    static void check(File e, File a, File g) {
        ...
        File g1 = new File("D:\\javaCode\\operation\\src\\Grade.txt");
        if (!g1.exists()){
            try {
                g1.createNewFile();
    ...
    static void save(List<List<String>> s) {
        ...
        File question = new File("D:\\javaCode\\operation\\src\\Exercises.txt");
        if (!question.exists()) {
    ...
    static void answer(List<String> a) {
        ...
        File answer = new File("D:\\javaCode\\operation\\src\\Answer.txt");
        if (!answer.exists()) {
